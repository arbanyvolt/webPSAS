...
const copy = {
  ...
  'hero.title': 'Time Fades, Heritage Remains.', 'hero.desc': 'Timepieces crafted with a quiet confidence. Our limited editions are not just for keeping hours, but for marking moments that deserve to outlive the cycle of trends. Every detail is chosen with care: clean dials, balanced proportions, and a steel glow that feels like a sophisticated whisper.', 'hero.cta1': 'Explore collection', 'hero.cta2': 'Read the story',
