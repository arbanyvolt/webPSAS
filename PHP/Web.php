...
<body>
  ...
  <header class="site-header">
    <div class="container header-wrap">
      <a href="#home" class="brand" aria-label="Chrocklock home">
        <span class="brand-mark">
          <img src="../Gambar/logo.png" alt="Logo Chrocklock" style="position: relative; top: 0px; height: 40px; width: auto;">
    ...
    <section class="hero" id="home">
      <div class="container hero-grid">
        <div class="hero-copy" data-reveal>
          ...
          <div class="stat-row">
            <article class="stat"><b>12</b><span data-i18n="stats.editions">Edisi terbatas per tahun</span></article>
            <article class="stat"><b>2 Year</b><span data-i18n="stats.warranty">Warranty</span></article>
            <article class="stat"><b>100%</b><span data-i18n="stats.curated">Estetika monokrom terkurasi</span></article>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="history-layout">
          <div class="timeline" data-reveal>
            <article class="timeline-item"><small data-i18n="history.i1t">Asal mula</small><p data-i18n="history.i1d">Berawal dari satu pertemuan sederhana antara penggemar jam tangan klasik dan meja kerja yang terlalu sering menjadi saksi tren lewat begitu saja. Di tengah kecepatan dunia, muncul keinginan untuk membuat sesuatu yang berjalan pelan—namun bertahan lebih lama.</p></article>
            <article class="timeline-item"><small data-i18n="history.i2t">Selera terkurasi</small><p data-i18n="history.i2d">Arah desain Chrocklock menjauh dari keramaian warna dan bentuk. Kami memilih bahasa monokrom: hitam, putih, dan bayangan di antaranya. Di dalamnya, setiap garis dan permukaan diberi ruang untuk bernapas, seolah jam ini ditata di etalase atelier kecil yang hanya dikunjungi mereka yang tahu apa yang mereka cari.</p></article>
            <article class="timeline-item"><small data-i18n="history.i3t">Boutique masa depan</small><p data-i18n="history.i3d">Struktur Chrocklock dibangun sejak awal untuk tumbuh tanpa kehilangan ketenangannya: siap disambungkan ke payment gateway, katalog yang lebih luas, dan domain yang lebih megah—namun tetap setia pada satu janji: menyuguhkan jam tangan klasik yang terasa seperti potongan puisi di pergelangan tangan.</p></article>
          </div>
  ...
  <a class="wa-float" href="https://wa.me/62856-0144-5637?text=Halo%20Chrocklock%2C%20saya%20ingin%20konsultasi%20koleksi%20jam%20tangan." target="_blank" rel="noopener noreferrer" aria-label="WhatsApp Chrocklock">
