      ...
      <div class="container">
        ...
        <div class="history-layout">
          <div class="timeline" data-reveal>
            ...
            <article class="timeline-item"><small data-i18n="history.i4t">Warisan Abadi</small><p data-i18n="history.i4d">Lebih dari sekadar instrumen pengukur waktu, ia adalah jembatan antargenerasi. Setiap karya dirancang untuk diwariskan, membawa cerita dan dedikasi yang tidak pernah usang oleh zaman.</p></article>
          </div>
    ...
    <div class="container">
      <div class="footer-top">
        ...
        <div class="footer-links">
          <div>
            <small data-i18n="footer.nav">Navigasi</small>
            <a href="#home" data-i18n="nav.home">Beranda</a>
            <a href="#collection" data-i18n="nav.collection">Koleksi</a>
            <a href="#history" data-i18n="nav.history">Narasi Sejarah</a>
          </div>
          <div>
            <small data-i18n="footer.contact">Kontak</small>
            <a href="mailto:Chroclock@gmail.com">Chroclock@gmail.com</a>
            <p>Purwokerto, Indonesia</p>
          </div>
          <div>
            <small data-i18n="footer.social">Media Sosial</small>
      ...
      <div class="footer-bottom">
        ...
        <span data-i18n="hero.eyebrow">Atelier Horologi Klasik</span>
      </div>
    </div>
  </footer>
