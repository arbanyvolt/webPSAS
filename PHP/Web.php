...
<body>
  ...
  <header class="site-header">
    <div class="container header-wrap">
      ...
      <div class="header-actions">
        ...
        <button class="icon-btn" id="openCartBtn" type="button" aria-label="Open cart">
    ...
    <section class="hero" id="home">
      <div class="container hero-grid">
        <div class="hero-copy" data-reveal>
          <p class="eyebrow">Curated Classic Watch Atelier</p>
          <h1>Time Fades, Heritage Remains.</h1>
          <p>Timepieces crafted with a quiet confidence. Our limited editions are not just for keeping hours, but for marking moments that deserve to outlive the cycle of trends. Every detail is chosen with care: clean dials, balanced proportions, and a steel glow that feels like a sophisticated whisper.</p>
          <div class="hero-actions">
            <a href="#collection" class="btn btn-primary">Explore collection</a>
            <a href="#history" class="btn btn-secondary">Read the story</a>
          </div>
          <div class="stat-row">
        ...
        <div class="hero-visual" aria-label="Hero gallery" data-reveal>
          <img class="hero-slide is-active" src="../Gambar/Jam1_1.png" alt="Classic watch display first view">
          <img class="hero-slide" src="https://pplx-res.cloudinary.com/image/upload/pplx_search_images/3fbc773f7948bb51bbff3d9e18ea42af023998ba.jpg" alt="Classic watch display second view">
          <img class="hero-slide" src="https://pplx-res.cloudinary.com/image/upload/pplx_search_images/27d4d15bcef056a3e7dff83e1de414dff044a9b1.jpg" alt="Classic watch display third view">
        </div>
      </div>
    </section>
    ...
    <section id="about">
      <div class="container">
        <div class="section-head" data-reveal>
          <div>
            <p class="eyebrow">About Chroclock</p>
            <h2>Quiet Design, Timeless Seconds.</h2>
          </div>
          <p>Made for those who value the weight of detail over the noise of branding. Within a monochrome palette, we honor honest forms, an interplay of archival inspiration and contemporary rhythm.</p>
        </div>
        <div class="about-grid">
          <article class="panel" data-reveal>
            <p class="quote">“True elegance never asks for attention, it waits to be noticed.”</p>
          </article>
          <article class="panel" data-reveal>
            <p class="eyebrow">Short stories</p>
            <p>Every collection begins with a single question: if all trends stopped today, would this watch still be worn with pride? From there, we choose proportions and textures that do not apologize to time, they simply converse softly with it.</p>
            <br />
            <p>We are not chasing a long list of references, but a complete presence. A bezel without excess, balanced lugs, a strap that feels like an extension of your hand, all directed toward one quiet aim: a watch that can represent you, even when you say nothing.</p>
          </article>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="section-head" data-reveal>
          <div>
            ...
            <h2>Limited Pieces for the Discerning Eye.</h2>
          </div>
          <p>Our collection is arranged like an intimate gallery: intentional in count, clean in silhouette, and rich in details that reveal themselves to those who look closely. Each watch arrives not to fill space, but to inhabit your next chapter.</p>
        </div>
      ...
      <div class="container">
        <div class="section-head" data-reveal>
          <div>
            ...
            <h2>Shaped by Heritage, Tuned to the Present.</h2>
          </div>
        </div>
        <div class="history-layout">
          <div class="timeline" data-reveal>
            <article class="timeline-item"><small>Origin</small><p>It began with a simple encounter between a lover of classic watches and a workbench that became a silent witness to a vision. Amid the pace of the world, there was a desire to create something that moves slowly, but stays much longer.</p></article>
            <article class="timeline-item"><small>Curated taste</small><p>Chroclock’s design direction walks away from visual noise. We speak in monochrome: black, white, and the shades in between. Every line is given room to breathe, as if each watch were placed in a small atelier window visited only by those who know what they are looking for.</p></article>
            <article class="timeline-item"><small>Future boutique</small><p>Chroclock is structured to grow without losing its quiet. We remain anchored to one promise: to offer classic watches that feel like a fragment of poetry resting on your wrist.</p></article>
            <article class="timeline-item"><small>Timeless Legacy</small><p>More than just an instrument for measuring time, it is a bridge between generations. Each piece is crafted to be passed down, carrying stories and dedication that never fade with the ages.</p></article>
          </div>
          <div class="history-gallery" data-reveal>
            <figure class="history-photo history-photo-lg"><img src="https://images.unsplash.com/photo-1523170335258-f5ed11844a49?auto=format&fit=crop&w=1200&q=80" alt="Workshop classic watches" loading="lazy"></figure>
            <figure class="history-photo"><img src="https://images.unsplash.com/photo-1547996160-81dfa63595aa?auto=format&fit=crop&w=900&q=80" alt="Classic watch details" loading="lazy"></figure>
            <figure class="history-photo"><img src="https://images.unsplash.com/photo-1508057198894-247b23fe5ade?auto=format&fit=crop&w=900&q=80" alt="Watch collection display" loading="lazy"></figure>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="container">
      <div class="footer-top">
        <div class="footer-brand">
          <h3>Chroclock</h3>
          <p>Classic luxury watches in a quiet, poetic, monochrome language.</p>
        </div>
        <div class="footer-links">
          ...
          <div>
            <small>Contact</small>
            <a href="mailto:Chroclock@gmail.com">Chroclock@gmail.com</a>
      ...
      <div class="footer-bottom">
        <span>© 2026 Chroclock. All rights reserved.</span>
      </div>
    </div>
  </footer>
  ...
  <div class="modal" id="cartModal" aria-hidden="true">
    <div class="modal-panel" style="max-width: 540px;">
      <button class="icon-btn modal-close" id="closeCartBtn" type="button" aria-label="Close modal">
      ...
      <div class="checkout-shell" style="grid-template-columns: 1fr;">
        ...
        <div class="panel checkout-panel-form" style="display: none;">
          ...
          <div class="eyebrow">Concierge order</div>
          <h2>Share the details, we’ll compose the rest.</h2>
          <p style="color:var(--color-text-muted);margin-top:var(--space-3)">Tell us your name and how to reach you.</p>
  ...
  <div class="modal" id="qtyModal" aria-hidden="true">
    <div class="modal-panel" style="max-width: 400px; text-align: center; padding: var(--space-6);">
      <button class="icon-btn modal-close" id="closeQtyBtn" type="button" aria-label="Close modal">
        <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M18 6 6 18M6 6l12 12"></path></svg>
      </button>
